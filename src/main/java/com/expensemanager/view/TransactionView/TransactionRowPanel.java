...
public class TransactionRowPanel extends JPanel {
    ...
    private static final Color CATEGORY_CHIP_BG = new Color(0xEDE9FE);
    private static final Color CATEGORY_CHIP_FG = new Color(0x7C3AED);
    private static final Color WALLET_CHIP_BG = new Color(0xE0F2FE);
    private static final Color WALLET_CHIP_FG = new Color(0x0369A1);
